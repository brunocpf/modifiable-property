...
Then install it via Unity's Package Manager UI by selecting "Add package from git URL..." and pasting the URL `https://github.com/brunocpf/modifiable-property.git`.

Unity will also pick up the package when placed in your project's `Packages/` folder as an embedded package.
